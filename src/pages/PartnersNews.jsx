    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container-premium pb-24">
        <section className="mt-20 mb-24">
          <div className="bg-[#0077b5] text-white p-12 flex flex-col lg:flex-row items-center justify-between gap-8 relative overflow-hidden group">
            ...
            <a href="#" className="relative z-10 bg-white text-[#0077b5] hover:bg-black hover:text-white transition-all duration-300 font-black uppercase px-8 py-4 italic tracking-widest text-sm">
              Accéder à la page
            </a>
            ...
            <article key={i} className="bg-slate-50 border border-slate-200 overflow-hidden group">
              <div className="p-10">
                <div className="flex justify-between items-center mb-6">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-black text-primary font-black italic flex items-center justify-center text-xs">RNR</div>
                    <div>
                      <div className="text-sm font-black uppercase tracking-tight italic">Rouen Normandie Rugby - Business Club</div>
                      <div className="text-xs font-bold text-slate-400 uppercase tracking-widest">{post.date}</div>
                    </div>
                  </div>
                ...
                <p className="text-slate-600 font-medium italic leading-relaxed mb-6">{post.content}</p>
                <div className="flex flex-wrap gap-2 mb-8">
                  {post.tags.map((tag, j) => (
                    <span key={j} className="text-xs font-black uppercase tracking-widest text-[#0077b5]">{tag}</span>
                  ))}
                </div>
              ...
              <div className="border-t border-slate-200 px-10 py-6 flex justify-between items-center bg-white/50">
                <div className="flex gap-8">
                  <button className="flex items-center gap-2 text-slate-400 hover:text-primary transition-colors text-xs font-black uppercase tracking-widest">
