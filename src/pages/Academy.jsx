...
import formationImg from "/assets/images/ui/www_formation.webp";
...
export default function Academy() {
  return (
    <div className="min-h-screen bg-white">
      <PageHero
        title="Centre de Formation & Espoirs"
        subtitle="La pépinière des Lions : former les talents de demain pour repousser nos limites."
