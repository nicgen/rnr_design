...
export default function AcademyWomen() {
  return (
    <div className="min-h-screen bg-white">
      <PageHero
        title="Les Équipes Féminines"
        subtitle="Découvrez l'effectif des Valkyries du Rouen Normandie Rugby pour la saison 2025-2026."
        bgImage={heroImg}
      ...
      <div className="container-premium pb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 relative">
              <div className="relative overflow-hidden shadow-2xl h-[500px]">
                <img src={heroImg} alt="Valkyries" className="w-full h-full object-cover scale-110" />
        ...
        <section className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-slate-50 p-12 relative overflow-hidden group hover:bg-black hover:text-white transition-all duration-500">
